...
import 'general/json_object_adapter.dart';
import 'general/map_json_object_adapter.dart';
import 'identity/app_identity_adapter.dart';
...
import 'session/built_list_session_devices_adapter.dart';
...
import 'session/session_device_adapter.dart';

class AuthAdaptersRegistrar {
  AuthAdaptersRegistrar();

  static void registerGeneralAdapters() {
    Hive.registerAdapter(MapJsonObjectAdapter());
    Hive.registerAdapter(JsonObjectAdapter());
  }
  ...
  static void registerIdentityAdapters() {
    Hive
      ..registerAdapter(AppIdentityAdapter())
  ...
  static void registerSessionAdapters() {
    Hive
      ...
      ..registerAdapter(BuiltListSessionDeviceAdapter())
      ..registerAdapter(SessionDeviceAdapter())
